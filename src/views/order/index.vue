<template>
  <div class="content-box">
    ...
    <el-card shadow="hover">
      ...
      <el-card v-show="pageData.total>0" shadow="never" class="mt-1"><el-pagination background layout="prev, pager, next, jumper" :total="pageData.total" :current-page.sync="pageData.pn" @current-change="handleCurrentChange" /></el-card>
    </el-card>
  </div>
</template>
